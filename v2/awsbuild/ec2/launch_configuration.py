...
class LaunchConfiguration():
    """ Class for the AWS Launch Configuration
    """
    ...
    def create(self):
        """ create the launch configuration(s)  """
        print('create TODO')

    def describe(self):
        """ get the launch configuration(s) info """
        print('describe TODO')

    def modify(self):
        """ modify the launch configuration(s) """
        print('modify TODO')

    def destroy(self):
        """ destroy the launch configuration(s) """
        print('destroy TODO')
